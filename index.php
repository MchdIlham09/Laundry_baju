...
<body class="fixed-left">
  ...
  <div id="wrapper">
    ...
    <div class="left side-menu">
      ...
      <div class="topbar-left">
        <div class="text-center">
          <a href="index.php"><img src="assets/images/laundry.jpeg" width="160px"></a>
        </div>
      </div>
    ...
    <div class="content-page background">
              ...
              <li class="list-inline-item dropdown notification-list">
                <a class="
                  ...
                  <?php if (!empty($tampilusers['userfoto'])) { ?>
                    <img src="fotouser/<?= $tampilusers['userfoto']; ?>" ; alt="user" class="rounded-circle" />
                  <?php } else { ?>
      ...
      <footer class="footer">
        <div class="copyright">
          &copy; Copyright <strong><span>2024</span></strong>. Laundry Baju
        </div>
        <div class="credits">
          <a>Tugas Uas Informatika Malam A || Kelompok 4 </a>
        </div>
      </footer>
    </div>
