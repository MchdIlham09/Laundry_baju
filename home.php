          ...
          <div class="page-title-box">
              <div class="btn-group float-right">
                  <ol class="breadcrumb hide-phone p-0 m-0">
                      <li class="breadcrumb-item"><a href="index.php">Laundry Baju</a></li>
                  ...
                  <div class="card-body">
                      <div class="d-flex flex-row">
                          ...
                          <div class="col-8 text-center align-self-center">
                              ...
                              <a href="?page=pelanggan" class="btn btn-primary mt-1">See all</a>
                          </div>
                  ...
                  <div class="card-body">
                      <div class="d-flex flex-row">
                          ...
                          <div class="col-8 text-center align-self-center">
                              ...
                              <a href="?page=users" class="btn btn-primary mt-1">See all</a>
                          </div>
                          <div class="col-10"></div>                             
                      </div>
                  </div>
                  ...
                  <div class="card-body">
                      <div class="d-flex flex-row">
                          ...
                          <div class="col-8 align-self-center text-center">
                              ...
                              <a href="?page=laundry" class="btn btn-primary mt-1">See all</a>
                          </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="card-body">
                      <div class="d-flex flex-row">
                          ...
                          <div class="col-8 align-self-center text-center">
                              ...
                              <a href="?page=pengeluaran" class="btn btn-primary mt-1">See all</a>
                          </div>
                      </div>
                  </div>
              </div>
